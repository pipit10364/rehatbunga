...
window.FLOWERS_FALLBACK = [
  ...
  },
  {
    ...
    "message": "Aku sudah ada jauh sebelum banyak bunga lain mengenal cara mekar, dan aku masih di sini, tenang, utuh. Kamu juga sudah melewati lebih banyak hal daripada yang kamu sadari.\n\nTidak apa-apa jika hari ini terasa berat, kamu tidak harus terlihat sempurna untuk tetap dianggap kuat. Berdirilah selembut mungkin, itu sudah cukup."
  },
  {
    ...
    "message": "Aku kecil, menunduk, hampir tidak terlihat di antara daun-daun besar. Tapi aku selalu kembali setiap musim, membawa aroma yang tenang.\n\nKebahagiaanmu boleh juga sekecil itu, seperti secangkir teh hangat, satu tarikan napas lega, satu pesan dari orang yang kamu sayang. Hal-hal kecil itu nyata, dan mereka akan terus kembali padamu."
  },
  {
    "id": "peony",
    "name": "Peony",
  ...
  },
  {
    ...
    "message": "Aku mekar lebih dulu dari bunga lain, bahkan saat udara masih dingin dan musim semi belum benar-benar datang. Bukan karena aku tidak takut, tapi karena aku percaya sesuatu yang baik sedang menuju kepadaku.\n\nKalau sekarang terasa seperti musim dingin bagimu, izinkan aku mengingatkan: sesuatu yang baik juga sedang menuju kepadamu, walau belum terlihat."
  },
  {
    "id": "chamomile",
    "name": "Chamomile",
  ...
  },
  {
    ...
    "message": "Aku tumbuh di mana saja, dari retakan aspal sampai pinggir jalan, tempat yang orang kira tidak mungkin ada kehidupan. Lalu saat waktunya tiba, aku melepas setiap benihku ke angin, membiarkan harapan pergi jauh tanpa tahu ke mana ia akan tumbuh.\n\nTitipkan harapanmu padaku. Aku akan membawanya, seringan mungkin, sejauh yang ia butuhkan untuk sampai."
  },
  {
    "id": "sunflower",
    "name": "Bunga Matahari",
